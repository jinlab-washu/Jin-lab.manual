...
with open(out_f, "w") as f:
	...
	filtered_e = filtered_e.annotate(nontopmed_AN=filtered_e.freq[group_e].AN)
	filtered_e = filtered_e.annotate(nontopmed_hom=filtered_e.freq[group_e].homozygote_count)
	
	filtered_g = filtered_g.annotate(nontopmed_cases=filtered_g.freq[group_g].AC-(filtered_g.freq[group_g].homozygote_count *2))
	filtered_g = filtered_g.annotate(nontopmed_AN=filtered_g.freq[group_g].AN)
	filtered_g = filtered_g.annotate(nontopmed_hom=filtered_g.freq[group_g].homozygote_count)
